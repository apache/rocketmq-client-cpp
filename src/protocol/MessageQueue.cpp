...
void MessageQueue::setBrokerName(const string& brokerName) { m_brokerName = brokerName; }
...
bool MessageQueue::operator<(const MessageQueue& mq) const { return compareTo(mq) < 0; }
