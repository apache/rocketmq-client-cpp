...
const map<string, string> ConsumerRunningInfo::getProperties() const { return properties; }

void ConsumerRunningInfo::setProperties(const map<string, string>& input_properties) { properties = input_properties; }

void ConsumerRunningInfo::setProperty(const string& key, const string& value) { properties[key] = value; }

const map<MessageQueue, ProcessQueueInfo> ConsumerRunningInfo::getMqTable() const { return mqTable; }

void ConsumerRunningInfo::setMqTable(MessageQueue queue, ProcessQueueInfo queueInfo) { mqTable[queue] = queueInfo; }
...
const vector<SubscriptionData> ConsumerRunningInfo::getSubscriptionSet() const { return subscriptionSet; }
...
void ConsumerRunningInfo::setJstack(const string& input_jstack) { jstack = input_jstack; }
