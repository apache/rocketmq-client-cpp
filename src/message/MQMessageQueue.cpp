...
void MQMessageQueue::setBrokerName(const std::string& brokerName) { m_brokerName = brokerName; }
...
bool MQMessageQueue::operator<(const MQMessageQueue& mq) const { return compareTo(mq) < 0; }
