...
void MQClient::setGroupName(const string &groupname) { m_GroupName = groupname; }

const string &MQClient::getNamesrvAddr() const { return m_namesrvAddr; }

void MQClient::setNamesrvAddr(const string &namesrvAddr) { m_namesrvAddr = namesrvAddr; }

const string &MQClient::getNamesrvDomain() const { return m_namesrvDomain; }

void MQClient::setNamesrvDomain(const string &namesrvDomain) { m_namesrvDomain = namesrvDomain; }

const string &MQClient::getInstanceName() const { return m_instanceName; }

void MQClient::setInstanceName(const string &instanceName) { m_instanceName = instanceName; }
...
int64 MQClient::minOffset(const MQMessageQueue &mq) { return getFactory()->minOffset(mq, m_SessionCredentials); }

int64 MQClient::maxOffset(const MQMessageQueue &mq) { return getFactory()->maxOffset(mq, m_SessionCredentials); }
...
void MQClient::setLogLevel(elogLevel inputLevel) { ALOG_ADAPTER->setLogLevel(inputLevel); }
...
const int MQClient::getTcpTransportPullThreadNum() const { return m_pullThreadNum; }

void MQClient::setTcpTransportConnectTimeout(uint64_t timeout) { m_tcpConnectTimeout = timeout; }
const uint64_t MQClient::getTcpTransportConnectTimeout() const { return m_tcpConnectTimeout; }
...
const uint64_t MQClient::getTcpTransportTryLockTimeout() const { return m_tcpTransportTryLockTimeout; }

void MQClient::setUnitName(string unitName) { m_unitName = unitName; }
const string &MQClient::getUnitName() { return m_unitName; }

void MQClient::setSessionCredentials(const string &input_accessKey, const string &input_secretKey,
...
const SessionCredentials &MQClient::getSessionCredentials() const { return m_SessionCredentials; }
