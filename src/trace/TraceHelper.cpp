  ...
  switch (ctx.getTraceType()) {
    case Pub: {
      ...
      ss << ctx.getTraceType() << TraceConstants::CONTENT_SPLITOR << ctx.getTimeStamp()
         ...
         << ctx.getGroupName() << TraceConstants::CONTENT_SPLITOR << bean.getTopic() << TraceConstants::CONTENT_SPLITOR
         << bean.getMsgId() << TraceConstants::CONTENT_SPLITOR << bean.getTags() << TraceConstants::CONTENT_SPLITOR
         << bean.getKeys() << TraceConstants::CONTENT_SPLITOR << bean.getStoreHost() << TraceConstants::CONTENT_SPLITOR
         << bean.getBodyLength() << TraceConstants::CONTENT_SPLITOR << ctx.getCostTime()
         << TraceConstants::CONTENT_SPLITOR << bean.getMsgType() << TraceConstants::CONTENT_SPLITOR
         << bean.getOffsetMsgId() << TraceConstants::CONTENT_SPLITOR << ctx.isSuccess()
    ...
    case SubAfter: {
      for (TraceBean bean : ctx.getTraceBeans()) {
        ss << ctx.getTraceType() << TraceConstants::CONTENT_SPLITOR << ctx.getRequestId()
           << TraceConstants::CONTENT_SPLITOR << bean.getMsgId() << TraceConstants::CONTENT_SPLITOR << ctx.getCostTime()
           << TraceConstants::CONTENT_SPLITOR << ctx.isSuccess() << TraceConstants::CONTENT_SPLITOR << bean.getKeys()
           << TraceConstants::CONTENT_SPLITOR << ctx.getContextCode() << TraceConstants::FIELD_SPLITOR;
