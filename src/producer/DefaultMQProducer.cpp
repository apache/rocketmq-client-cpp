    ...
    switch (m_serviceState) {
        case CREATE_JUST: {
            ...
            if (!registerOK) {
                ...
                THROW_MQEXCEPTION(MQClientException, "The producer group[" + getGroupName() +
...
SendResult DefaultMQProducer::send(MQMessage& msg, MessageQueueSelector* pSelector, void* arg, int autoRetryTimes,
                                   bool bActiveBroker) {
    try {
...
void DefaultMQProducer::setSendMsgTimeout(int sendMsgTimeout) { m_sendMsgTimeout = sendMsgTimeout; }

int DefaultMQProducer::getCompressMsgBodyOverHowmuch() const { return m_compressMsgBodyOverHowmuch; }
...
void DefaultMQProducer::setMaxMessageSize(int maxMessageSize) { m_maxMessageSize = maxMessageSize; }
...
//<!************************************************************************
SendResult DefaultMQProducer::sendDefaultImpl(MQMessage& msg, int communicationMode, SendCallback* pSendCallback,
                                              bool bActiveMQ) {
...
SendResult DefaultMQProducer::sendKernelImpl(MQMessage& msg, const MQMessageQueue& mq, int communicationMode,
...
SendResult DefaultMQProducer::sendSelectImpl(MQMessage& msg, MessageQueueSelector* pSelector, void* pArg,
                                             int communicationMode, SendCallback* sendCallback) {
    Validators::checkMessage(msg, getMaxMessageSize());
...
SendResult DefaultMQProducer::sendAutoRetrySelectImpl(MQMessage& msg, MessageQueueSelector* pSelector, void* pArg,
                                                      int communicationMode, SendCallback* pSendCallback,
                                                      int autoRetryTimes, bool bActiveMQ) {
    Validators::checkMessage(msg, getMaxMessageSize());
...
int DefaultMQProducer::getRetryTimes4Async() const { return m_retryTimes4Async; }
