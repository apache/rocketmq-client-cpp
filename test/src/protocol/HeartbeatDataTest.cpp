...
TEST(heartbeatData, ConsumerData) {
    ...
    EXPECT_EQ(outJson["consumeFromWhere"], ConsumeType::CONSUME_ACTIVELY);
    EXPECT_EQ(outJson["consumeType"].asInt(), MessageModel::BROADCASTING);
    EXPECT_EQ(outJson["messageModel"].asInt(),
...
int main(int argc, char* argv[]) {
    ...
    testing::GTEST_FLAG(filter) = "heartbeatData.HeartbeatData";
