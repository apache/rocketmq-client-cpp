...
TEST(topicConfig, init) {
    ...
    EXPECT_EQ(topicConfig.getReadQueueNums(),
              TopicConfig::DefaultReadQueueNums);
    EXPECT_EQ(topicConfig.getWriteQueueNums(),
              TopicConfig::DefaultWriteQueueNums);
    EXPECT_EQ(topicConfig.getPerm(),
    ...
    EXPECT_EQ(twoTopicConfig.getReadQueueNums(),
              TopicConfig::DefaultReadQueueNums);
    EXPECT_EQ(twoTopicConfig.getWriteQueueNums(),
              TopicConfig::DefaultWriteQueueNums);
    EXPECT_EQ(twoTopicConfig.getPerm(),
              PermName::PERM_READ | PermName::PERM_WRITE);
    ...
    EXPECT_EQ(threeTopicConfig.getTopicFilterType(),
