...
TEST(memoryBlock, init) {
    ...
    EXPECT_TRUE(eightMemoryBlock.getData() == NULL);
...
TEST(memoryBlock, operators) {
    ...
    EXPECT_TRUE(appendMemoryBlock.getData() == NULL);
